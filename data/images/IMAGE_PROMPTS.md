...
> A fixed camera view from a utility pole showing heavy ice accumulation on distribution power line conductors. Approximately 8-10mm of radial ice coating visible on the upper phase conductor, making it appear roughly twice its normal diameter. The ice is clear glaze ice (freezing rain accumulation), not rime or snow. The conductor shows increased sag due to the ice weight. The pole-mounted camera captures the conductor at close range with a crossarm visible. Heavy overcast sky, active freezing rain. Bare tree branches in background also show ice accumulation. North Carolina ice storm conditions. Utility monitoring camera perspective.
